...
<div align="center" >
  <img alt="Примеры изображений для сравнения" src="./assets/loss_samples/all_samples.png" width="400px" />
</div><br/>

Здесь качественно каждое из пар верхнего и нижнего изображений достаточно далеки друг от друга. Однако по содержанию (а именно это и важно в задаче) очень близки. От функции потерь гораздо более важно показать именно то, насколько смысловое содержание сгенерированного и реального изображений схожи, нежели их качественная похожесть (оттенки, яркость, текстура). 
...
Код представлен в блокноте: [gan.ipynb](./encoder.ipynb).
